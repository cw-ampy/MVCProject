...
CREATE table image_aman(image_link VARCHAR(255) PRIMARY KEY,id INT NOT NULL, FOREIGN KEY(id) REFERENCES products_aman(id));
...
INSERT INTO image_aman(image_link, id) values
